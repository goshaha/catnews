...
<?php else:?>
    ...
    <?= Html::button('<span class="glyphicon glyphicon-comment"> <b>Обсудить</b></span>',
    ['value'=>Url::to(['sub-comment-create','id' => $category['id']]),'class' => 'btn btn-success btn-xs position_right ','data-toggle'=>'popover','data-content'=>'Вам нужно зарегистрироваться']);?>
